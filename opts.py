...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--data_dir', type=str, default='/home/lijiacheng/VSCMR/VIST')
    ...
    parser.add_argument('--semantics_json', type=str, default='VIST/semantic_set.json')
    ...
    parser.add_argument('--semantic_length', type=int, default=50, help='pad_length for semantics')
    ...
    parser.add_argument('--learning_rate', type=float, default=4e-04, help='learning rate')
